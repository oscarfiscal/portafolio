<template>
    <section id="contact">
      ...
      <div class="contact-section">
        <p>¿Tienes un proyecto o necesitas reforzar tu equipo de desarrollo? ¡Envíame un mensaje!</p>
        <form @submit.prevent="sendTelegram">
          ...
          <label>
            Teléfono:
            <input type="tel" v-model="formPhone" placeholder="+57 3001234567" required />
          </label>
          <label>
            Mensaje:
